            ...
            <div class="row mt-2">
                <div class="col-12 col-lg-9">
                    <div id="stream_container">
                        <div class="embed-responsive embed-responsive-16by9 bg-black mb-1 mb-lg-2" id="stream_video">
                            <iframe class="embed-responsive-item" :src="streamUrl" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                ...
                <div class="col-12 col-lg-3 mb-2" :style="{opacity: isFinishCalculated? 1 : 0}">
                    <live-chat :isFinishCalculated.sync="isFinishCalculated" :room="room" source="auditorium"></live-chat>
                </div>
            </div>
        </div>
